...
int main( int argc, const char** argv )
{
    ...
    #else
        std::cerr << "Warning: OpenCV was built without Qt support. Buttons are disabled." << std::endl;
        // Optionally: call one of the effects immediately to demo
        showHistoCallback(0, nullptr);
    #endif
    ...
    do {
        ...
        switch (key) {
            case 'h':
                ...
                break;
            case 'e':
                equalizeCallback(0, nullptr);
                break;
            case 'l':
                lomoCallback(0, nullptr);
                break;
            case 'c':
                cartoonCallback(0, nullptr);
                break;
            default:
                break;
        }
