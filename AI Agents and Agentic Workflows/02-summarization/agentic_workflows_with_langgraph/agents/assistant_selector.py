...
def select_assistant(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        default_assistant = {
            "assistant_type": "Ümumi tədqiqat köməkçisi",
            "assistant_instructions": "Sən ümumi tədqiqat üzrə süni intellekt köməkçisisən. Əsas məqsədin verilmiş mövzular üzrə əhatəli, informativ, obyektiv və yaxşı strukturlaşdırılmış hesabatlar hazırlamaqdır.",
